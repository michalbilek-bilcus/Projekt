    ...
    <div class="games-menu">
        ...
        <div class="game">
            <div class="game-title">fast click
                <div class="hover-div">
                Jednoduchá hra, kde hráč kliká na různé objekty na obrazovce, aby získal body nebo jiné odměny. Cílem je kliknout co nejrychleji a co nejvícekrát v daném časovém limitu.
                </div>
            </div>
