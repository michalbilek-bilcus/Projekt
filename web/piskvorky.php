    ...
    <div class="game-container">
        <div class="game">
            ...
            <div class="btns" id="btns">
                ...
                <button class="btn" id="btn1" onclick="location.href='mainmenu.php';">Main menu</button>
            </div>       
        </div>
        <div class="after-game" id="after-game">
          ...
          <div class="btns">
            <button class="btn" onclick="resetBoard()">Play again</button>
            <button class="btn" onclick="location.href='mainmenu.php';">Main menu</button>
          </div>         
        </div>
